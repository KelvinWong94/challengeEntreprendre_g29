...
# CONFIGURATION DE L'API GEMINI (DANS LA SIDEBAR)
with st.sidebar:
...
if not st.session_state.results_df.empty:
    ...
    # --- Graphiques ---
    tab1, tab2, tab3 = st.tabs(["📈 Évolution Mensuelle", "📦 Répartition par Catégorie", "🍰 Vue Camembert"])
    ...
    with tab3:
        st.subheader("Répartition des Émissions Totales par Catégorie")
        ...
        fig_pie = px.pie(
            ...
            names='category',
            values='carbon_kg',
            title='Pourcentage des Émissions par Catégorie',
            color_discrete_sequence=px.colors.sequential.Greens_r # Palette de couleurs
        )
